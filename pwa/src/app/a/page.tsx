 ...
 *
 * A chave leva a versão no nome: quem experimenta as duas interfaces precisa de
 * uma conversa separada em cada, senão a segunda retomaria a sessão da primeira
 * e as duas ficariam indistinguíveis na revisão.
 */
